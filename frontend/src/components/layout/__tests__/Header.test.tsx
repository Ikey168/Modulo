...
describe('Header', () => {
  ...
  it('renders a single header bar with brand and theme switcher', () => {
    ...
    expect(screen.getByRole('link', { name: /modulo/i })).toHaveAttribute('href', '/app/dashboard');
  ...
  it('opens the More menu with the secondary destinations', async () => {
    ...
    expect(within(menu).getByRole('menuitem', { name: 'Graph' })).toHaveAttribute('href', '/app/graph');
