...
const markdownComponents: Components = {
  ...
  a: ({ node, ...props }) => { void node; return <PrivateAttachmentLink {...props} className="font-medium text-primary-hover underline-offset-2 hover:underline" />; },
  ...
  img: ({ node, ...props }) => { void node; return <PrivateAttachmentImage {...props} className="my-3 h-auto max-w-full rounded-md border border-border" />; },
