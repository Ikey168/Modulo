import { ResearchWithNoesis } from '../research/ResearchWithNoesis';
import { objectReference } from '../research/model';
  ...
  return (
    ...
    >
      ...
      {editing ? (
        ...
        <>
          {children}
          {objectReference(record, title) && <ResearchWithNoesis reference={objectReference(record, title)} />}
        </>
      )}
