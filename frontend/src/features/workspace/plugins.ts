...
/** Goals and longer-running arcs over Projects and Areas. */
...
export const PLUGINS: PluginInfo[] = [
  ...
  { id: PARA_GOALS_PLUGIN_ID, name: 'Goals & Arcs', desc: 'A directional layer spanning multiple Projects and Areas without turning goals into another task list.', category: 'para', subcategory: 'Direction', downloads: '0', rating: 'New', icon: Target },
