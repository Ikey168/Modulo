...
declare global {
  interface Window {
    moduloDesktop?: {
      ...
      readonly webWatch: {
        sync: (items: Array<{ id: string; title: string; url: string; selector?: string; frequencyMinutes: number; lastHash?: string; lastChecked?: string; lastChanged?: string; status: string }>) => Promise<number>;
        check: (ids?: string[]) => Promise<Array<{ id: string; title: string; url: string; status: string; lastHash?: string; lastChecked?: string; lastChanged?: string; error?: string }>>;
        onChanged: (listener: (value: { id: string; lastHash: string; lastChecked: string; lastChanged: string }) => void) => () => void;
      };
      readonly documents: {
