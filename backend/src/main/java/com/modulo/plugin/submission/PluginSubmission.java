...
public class PluginSubmission {
    ...
    public String getMaxPlatformVersion() { return maxPlatformVersion; }
    ...
    public boolean isSecurityCheckPassed() { return securityCheckPassed; }
    public void setSecurityCheckPassed(boolean securityCheckPassed) { this.securityCheckPassed = securityCheckPassed; }
    public boolean isCompatibilityCheckPassed() { return compatibilityCheckPassed; }
    public void setCompatibilityCheckPassed(boolean compatibilityCheckPassed) { this.compatibilityCheckPassed = compatibilityCheckPassed; }
