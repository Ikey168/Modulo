...
| [#421](https://github.com/Ikey168/Modulo/issues/421) | State P7: migrate embedded Database records to synchronized plugin state | Versioned per-fence persistence, migration, view settings and retention policy implemented; focused tests pass, publication pending. |
